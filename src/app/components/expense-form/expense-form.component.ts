...
@Component({
  ...
  template: `
    <div class="bg-white rounded-lg border border-gray-200 p-6">
      <h3 class="text-lg font-semibold text-gray-900 mb-4">➕ Agregar Nuevo Gasto</h3>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            @if (form.get('amount')?.invalid && form.get('amount')?.touched) {
              <p class="mt-1 text-sm text-red-600">El importe es requerido y debe ser mayor a 0</p>
            }
          </div>
